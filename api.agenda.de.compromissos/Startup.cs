...
using api.agenda.de.compromissos.Repositories;
...
namespace api.agenda.de.compromissos
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            {
                c.SwaggerDoc("v1", new OpenApiInfo { Title = "Api Agenda de Compromissos", Version = "v1"});
            });
        }
        ...
        public void Configure(IApplicationBuilder app, IHostingEnvironment env)
        {
            ...
            app.UseSwaggerUI(c =>
            {
                c.SwaggerEndpoint("/swagger/v1/swagger.json", "Api Agenda de Compromissos");
            });
        }
    }
}
